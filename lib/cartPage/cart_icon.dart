  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title:
            Text('My Cart',style: TextStyle(fontSize: 18,fontWeight: FontWeight.normal),),
        // Image.network(
                                  ...
                                  child: Center(
                                    child: Container(
                                      child: Column(
                                        ...
                                        children: [
                                          Center(
                                            child: Text(giftDetails[index]['sort_description'],style: TextStyle(fontSize: 14),
                                          ...
                                          Padding(
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                Text('₹ ${giftDetails[index]['prize'].toString()}',),
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      IconButton(
                                        ...
                                        icon: const Icon(Icons.delete_outlined,size: 24,color: Colors.grey,
                                        ),
                                      ),
                                      SizedBox(width: 4,),
                                      Text('Remove',style: TextStyle(color: Colors.grey,fontSize: 14),),
                                    ],
                                  ),
                                ),
                                VerticalDivider(
                                  ...
                                  child: Row(
                                    children: [
                                      IconButton(
                                        ...
                                        icon: const Icon(Icons.shopping_cart_checkout_outlined,size: 24,color: Colors.grey,
                                        ),
                                      ),
                                      //Icon(Icons.shopping_cart_checkout_outlined,size: 24,color: Colors.grey,),
                                      SizedBox(width: 4,),
                                      Text('Buy Now',style: TextStyle(color: Colors.grey,fontSize: 14),),
                                    ],
                                  ),
